...
path_to_videos = "C:/Users/Danish/Desktop/MC A1/Mobile_Computing_Group14/uploads/";
...
def convert_to_csv(path_to_video):
    ...
    pd.DataFrame(csv_data, columns=columns).to_csv(path_to_videos + 'key_points.csv', index_label='Frames#')
